            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$category->id}}</a>
                        </td>
                        <td>
                            @if ($category->image != '')
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$category->image}}</span>

                            @endif
                            <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                <span class="symbol-label font-size-h5 font-weight-bold">{{$category->name}}</span>
                            </span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="label label-lg label-light-success label-inline">{{$category->status}}</span>
                        </td>
                        <td class="pr-0 text-right">
                            ...
                            <form class="delete" style="display: inline-block" action="{{route('categories.destroy', $category->id)}}" method="POST">
                                @method('delete')
                                @csrf
