            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$service->id}}</a>
                        </td>
                        <td>
                        ...
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->description}}</span>
                        </td>
