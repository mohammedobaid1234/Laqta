            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$social->id}}</a>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$social->name}}</span>

                        </td>

                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><a
                                    href="http://{{$social->link}}">Open Link</a></span>
                        </td>
